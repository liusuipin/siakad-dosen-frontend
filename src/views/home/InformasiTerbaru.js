...
class InformasiTerbaru extends Component {
                                ...
                                <Col sm="12">
                                    <div>
                                        <Breadcrumb className="breadcrumb-me">
                                            <BreadcrumbItem><Link to="/beranda"><i className="far fa-newspaper"></i> Informasi Tebaru</Link></BreadcrumbItem>
                                            <BreadcrumbItem active>Detail Berita</BreadcrumbItem>
                                        </Breadcrumb>
                                    </div>
                                </Col>
                                <Col sm="12" className="mt-2">
                                    <h6 className="mb-2">Mahasiswa Program Studi PTIK Juara Web E-Commerce Tingkat Nasional</h6>
                                </Col>
                            </Row>
                        </div>
                        {/* <Footer /> */}
...
export default GlobalConsumer(InformasiTerbaru);
